...
Pagination.prototype.jinyong=function(){
    ...
    if(pagenum2==totalPage2){
        //禁用下一页和尾页
        divs[3].style.backgroundColor="#fff"
        divs[4].style.backgroundColor="#ddd"
    }
}
//显示文本信息
...
Pagination.prototype.showP=function(){
    ...
    if(totalPage1<10){
        ...
        span1.setAttribute('disabled','disabled')
        span1.style.cssText="border:1px solid #ddd,padding:0px 5px;margin:0px;background-color: #fff;";
        // $('span1').hover(function(){
        //     span1.style.cssText="color: #777;cursor: not-allowed;background-color: #fff;border-color: #ddd;"
        // })
    }
}
//动起来
